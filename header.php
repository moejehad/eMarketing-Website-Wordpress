...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/css/single.css" type="text/css" />
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/css/animation.css" type="text/css" />
  ...
  <header>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
        <ul class="social list-unstyled list-inline wow slideInDown">
      ...
      <div class="Info">
          <div class="container">
         <div class="phone">
           <div class="info-tele wow slideInLeft">
      ...
      <nav>
            <div class="container">
               <div class="logo">
                  <a href="<?php bloginfo('home'); ?>" class="logo wow slideInRight">
               ...
               <div id="navbar-main">
                  ...
                  <ul class="nav navbar-nav navbar-left wow slideInDown">
      ...
      <div class="Header">
            <div class="container">
               <div class="content header-content">
                  <h1 class="wow slideInDown">رقمية <span>للخدمات التكنولوجية</span></h1>
                  <p class="wow slideInUp"> أفضل الخدمات التكنولوجية</p>
                  <a href="#"><button type="button" class="btn btn-info wow slideInLeft">خدماتنا</button></a>
               </div>
            </div>
         </div>
